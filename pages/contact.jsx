        ...
        <BannerLayout>
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-5 text-xs">
                        <div className="card_stylings w-full md:w-1/2 p-5 md:p-6 lg:p-8 flex flex-col gap-y-4">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <span className='text-LightGray md:text-sm'>wiseneosco india pvt. ltd</span>
                            </div>
                        </div>
                        <div className="card_stylings rounded-xl w-full md:w-1/2 p-5 md:p-6 lg:p-8 flex flex-col gap-y-4">
                            <div className="flex justify-between items-center">
                                <span className='md:text-base'>Email:</span>
                                <span className='text-LightGray text-sm'>rajnishpandey010@gmail.com</span>
                            </div>
                            <div className="flex justify-between items-center">
                                <span className='md:text-base'>Linkedin:</span>
                                <span className='text-LightGray text-sm'>Rajnish Pandey</span>
                            </div>
                            <div className="flex justify-between items-center">
                                <span className='md:text-base'>Phone:</span>
                                <span className='text-LightGray text-sm'>+91 7985574363</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="h-16 w-full card_stylings text-xl sm:text-3xl flex gap-x-8 sm:gap-x-16 items-center justify-center text-Snow">
                    <a className='hover:scale-125 ease-in-out duration-700' href="rajnishpandey010@gmail.com" target='_blank' rel="noreferrer"><HiMail /></a>
                    <a className='hover:scale-125 ease-in-out duration-700' href="https://github.com/rjrajnish" target='_blank' rel="noreferrer"><FaGithub /></a>
                    <a className='hover:scale-125 ease-in-out duration-700' href="https://www.linkedin.com/in/rajnish-pandey-21a47a1a7/" target='_blank' rel="noreferrer"><FaLinkedin /></a>
            ...
            >
                <div className='flex flex-col items-center justify-center'>
                    ...
                    <a className='underline text-Snow' target='_blank' href='https://github.com/rjrajnish'>Be the one to integrate this!</a>
                </div>
            </Modal>
            <Footer />
        </BannerLayout>
