...
const Contact = () => {
  ...
  const sendHandler = () => {
    ...
    if (!name && !email) {
      return  swal({
        title: "Opps!",
        text: "Please insert name, Email and Message!",
        icon: "warning",
      });
    }
    // Sending data to the specified email address (rajnishpandey010@gmail.com)
    axios
      ...
      <div className=" px-4 py-2">
        ...
        <div className="h-16 w-full card_stylings text-xl sm:text-3xl flex gap-x-8 sm:gap-x-16 items-center justify-center text-Snow">
          <a
            ...
            href="rajnishpandey010@gmail.com"
            target="_blank"
            rel="noreferrer"
          >
            <HiMail />
          ...
          <a
            className="hover:scale-125 ease-in-out duration-700"
            href="https://github.com/rjrajnish"
            target="_blank"
            rel="noreferrer"
          >
            <FaGithub />
          ...
          <a
            className="hover:scale-125 ease-in-out duration-700"
            href="https://www.linkedin.com/in/rajnish-pandey-21a47a1a7/"
            target="_blank"
            rel="noreferrer"
          >
            <FaLinkedin />
        ...
        <div className="my-12 w-full h-auto text-Snow">
          ...
          <div className="mt-4 py-8 px-8 bg-EveningBlack rounded-xl text-sm">
            <div>
              ...
              <div className="my-4">
                <button onClick={sendHandler} className="button">
                  {" "}
                  SEND MESSAGE{" "}
                </button>
              </div>
