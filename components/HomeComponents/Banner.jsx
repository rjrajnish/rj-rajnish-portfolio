      ...
      <div className="absolute inset-0 z-20 flex flex-col items-center py-6 justify-center w-full h-full bg-gradient-to-t from-MidNightBlack">
        <div className="bg-LightGray/10 w-[95%] h-[90%] px-4 py-2 rounded-xl overflow-hidden flex md:block">
          <div className="flex items-center md:items-center md:justify-around">
            <div className="">
              <div className="">
                <span className="text-3xl sm:text-4xl xl:text-5xl text-Snow font-bold">
                  👋 Welcome,
                </span>
                <span className="text-3xl sm:text-4xl xl:text-5xl text-Snow font-bold block text-green-400">
                  Discover Something Amazing!
                </span>
              </div>
              <div className="">
                <div className=" py-2 font-cascadia-normal text-Snow pb-3 text-xs h-15 lg:h-auto">
                  <span>
                    {"<"}
